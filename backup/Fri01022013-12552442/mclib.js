...
/**
    ...
    @param {boolean} scale True if timeout should be mutiplied by number of processes in list.
    @constructor
    @namespace mclib
**/
mclib.ProcessList = function (timeout, scale) {
    "use strict";
        ...
        **/
        add: function (process, argsObj) {
            ...
            if (process) {
                ...
                setTimeout(_execute, timeout * ((scale) ? _list.length : 1));
