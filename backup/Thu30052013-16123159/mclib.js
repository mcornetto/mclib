        ...
        **/
        ...
        /**
            ...
            @example
                ...
                loading.trigger({value: "whilst loading"});
        **/
        triggerAsynch: function (argsObj) {
                   ...
                   **/
                    ...
                    **/
                    destroy: function (verbs) {
                        ...
                        pouch.beforeDestroy.triggerAsynch({ pouch: pouch, verbs: verbs });
    ...
    function _execute() {
        ...
        if (_list.length > 0) {
            ...
            if (typeof (process[0]) === "function") {
                ...
                _processed++;
                _progress.triggerAsynch({ processed: _processed, process: process });

            }
            else {
                _invalid.triggerAsynch({ process: process });
            }

            if (_list.length === 0) {
                _started = false;
                _listEmpty.triggerAsynch();
            }
            else {
    ...
    return {
        ...
        **/
        Scripts: function () {
            ...
            **/
            function _add(name, url, condition) {
                if (_scriptholder[name]) {
                    throw (name + ' already exists. Use a different name.');
                }

                _scriptholder[name] = { url: url, injected: condition() };
            }
            /**
