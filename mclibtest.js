...
mclib.test.add("testEvent", "Test Event", function () {
    ...
    event.triggerAsync({ value: 2, obj: this });
    ...
    event.triggerAsync({ value: 3, obj: this });
...
mclib.test.add("testInjectScripts", "Test injectScripts", function () {
    ...
    injector.add("jquery", 'http://code.jquery.com/jquery-1.10.0.min.js', true, function () {
        return (typeof (jQuery) !== "undefined");
    });

    injector.add("injectCSS", 'http://forum.writerarena.com/custom/sdks/jquery.injectCSS.js', true, function () {
